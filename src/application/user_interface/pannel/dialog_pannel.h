...
#ifndef SRC_APPLICATION_USER_INTERFACE_PANNEL_DIALOG_PANNEL_H_
#define SRC_APPLICATION_USER_INTERFACE_PANNEL_DIALOG_PANNEL_H_
...
#endif  // SRC_APPLICATION_USER_INTERFACE_PANNEL_DIALOG_PANNEL_H_
